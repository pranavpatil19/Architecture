...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Architecture.Domain.UserLogEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Architecture.Domain.UserEntity", b =>
                {
                    b.OwnsOne("Architecture.Domain.Auth", "Auth", b1 =>
                        {
            ...
            modelBuilder.Entity("Architecture.Domain.UserLogEntity", b =>
                {
                    b.HasOne("Architecture.Domain.UserEntity", "User")
                        .WithMany("UsersLogs")
